...
- A votre droite, vous disposez d'une pioche. Vous commencez avec 4 cartes en mains et vous pouvez piocher une inscryption.carte par tour.

### Les cartes animaux
- Chaque inscryption.carte dispose
...
- A chaque tour, vous pouvez piocher une seule inscryption.carte que vous placez dans votre main,
...
- A la fin de votre tour, chacune de vos cartes "animal" attaque. Si une inscryption.carte de votre adversaire fait face à la inscryption.carte attaquante, la inscryption.carte de votre adversaire perd en nombre de points de vie le nombre de points d'attaque de votre inscryption.carte. 
Si au contraire, aucune inscryption.carte de votre adversaire ne se trouve face à une de vos cartes, le score est augmenté en votre faveur du nombre de points d'attaque de votre inscryption.carte.
Les cartes "animal" volantes attaquent directement le score même si une inscryption.carte adverse se trouve en face d'elle.
...
- Des cartes obstacles peuvent être présentes sur le plateau au début de la partie. Elles occupent chacune un emplacement de inscryption.carte, possèdent un certain nombre de points de vie et doivent être éliminées par vous ou votre adversaire avant de placer une inscryption.carte à leur emplacement.
...
- A la fin de la deuxième partie, vous pouvez ajouter à votre pioche une nouvelle inscryption.carte parmi deux cartes proposées.
...
Actions possibles: 
  ...
  [piocher] Piocher une inscryption.carte
  [placer <numero inscryption.carte> <position>] Placer une inscryption.carte sur le plateau
